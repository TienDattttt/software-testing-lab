...
short src_ln1 [] = {
	  0,  42,  20,  20,  20,  20,  20,  20, 
	 20,  20,  45,  46,  47,  49,  49,  50, 
	 21,  21,  21,  21,  21,  21,  53,  54, 
	 54,  41,  56,  41,  56,   0, };
S_F_MAP src_file1 [] = {
	{ "-", 0, 0 },
	{ "bb.pml", 1, 28 },
...
short src_ln0 [] = {
	  0,  25,  26,  20,  20,  20,  20,  20, 
	 20,  20,  20,  29,  30,  31,  32,  21, 
	 21,  21,  21,  21,  21,  35,  36,  36, 
	 24,  38,  24,  38,   0, };
S_F_MAP src_file0 [] = {
	{ "-", 0, 0 },
	{ "bb.pml", 1, 27 },
...
#ifndef NOCLAIM
	case 5:	/* claim select */
		spin_c_typ[0] = 3; /* bounded_top */
		((P5 *)pptr(h))->c_cur[0] = 6;
		reached3[6]=1;
		spin_c_typ[1] = 2; /* mutual_exclusion */
		((P5 *)pptr(h))->c_cur[1] = 6;
		reached2[6]=1;
		((P5 *)pptr(h))->_t = 2;
		((P5 *)pptr(h))->_p = 6;
		((P5 *)pptr(h))->_n = 1; /* mutual_exclusion */
		src_claim = src_ln2;
#ifndef BFS
...
iniglobals(int calling_pid)
{
	...
	{	int l_in;
		...
		logval("top", now.top);
		logval("notFull", now.notFull);
		logval("notEmpty", now.notEmpty);
		logval("s", now.s);
		logval("pcount", now.pcount);
		logval("ccount", now.ccount);
#endif
}
...
{	/* int i; */
	...
	printf("	byte   top:	%d\n", now.top);
	printf("	byte   notFull:	%d\n", now.notFull);
	printf("	byte   notEmpty:	%d\n", now.notEmpty);
	printf("	byte   s:	%d\n", now.s);
	printf("	byte   pcount:	%d\n", now.pcount);
	printf("	byte   ccount:	%d\n", now.ccount);
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
